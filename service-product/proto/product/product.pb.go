...
var file_proto_product_product_proto_rawDesc = []byte{
	...
	0x32, 0xea, 0x01, 0x0a, 0x11, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x64,
	...
	0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x32, 0x0a, 0x06, 0x43,
	...
	0x2c, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x64,
	0x75, 0x63, 0x74, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x1a, 0x10, 0x2e, 0x70, 0x72,
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x42, 0x10, 0x5a,
...
var file_proto_product_product_proto_depIdxs = []int32{
	...
	2, // 3: product.ServiceProductRPC.Create:input_type -> product.CreateRequest
	0, // 4: product.ServiceProductRPC.UpdateStock:input_type -> product.Product
	0, // 5: product.ServiceProductRPC.GetById:output_type -> product.Product
	1, // 6: product.ServiceProductRPC.GetList:output_type -> product.GetListResponse
	0, // 7: product.ServiceProductRPC.Create:output_type -> product.Product
	0, // 8: product.ServiceProductRPC.UpdateStock:output_type -> product.Product
