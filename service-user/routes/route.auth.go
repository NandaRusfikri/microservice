...
import (
	...
	"gorm.io/gorm"
	handlers "service-user/controllers/auth"
	repositorys "service-user/repositorys/auth"
	services "service-user/services/auth"
)
...
func InitAuthRoutes(db *gorm.DB, route *gin.Engine) {
	...
	*/
	...
	resultRepository := repositorys.NewRepositoryResults(db)
	resultService := services.NewServiceResults(resultRepository)
	resultHandler := handlers.NewHandlerResultsUser(resultService)
	...
	*/
	...
	groupRoute.POST("/user/list", resultHandler.ResultsAuthHandler)
